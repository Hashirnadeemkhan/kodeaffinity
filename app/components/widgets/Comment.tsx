  ...
  return (
    <div className="max-w-4xl mx-auto p-6 mt-24 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg transition-colors duration-300">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 focus:ring-2 focus:ring-purple-400 focus:outline-none transition-all duration-300"
        >
          Submit
        </button>
      </form>
      ...
      <div className="mt-10">
        ...
        >
          {comments.map((comment, index) => (
            ...
            >
              <p className="text-red-600 dark:text-red-400 font-semibold">{comment.name}:</p>
