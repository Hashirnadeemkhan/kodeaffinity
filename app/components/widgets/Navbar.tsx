    ...
    <nav className="bg-white shadow-md mx-auto top-4 w-[90%] lg:w-[85%] rounded-lg z-10">
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-lg px-6 py-4 text-center">
          <Link href="/" className="block text-gray-800 hover:text-gray-600 mb-2" onClick={handleLinkClick}>Home</Link>
          <Link href="/about" className="block text-gray-800 hover:text-gray-600 mb-2" onClick={handleLinkClick}>About us</Link>
          <Link href="/services" className="block text-gray-800 hover:text-gray-600 mb-2" onClick={handleLinkClick}>Services</Link>
          <Link href="/blogs" className="block text-gray-800 hover:text-gray-600 mb-2" onClick={handleLinkClick}>Blogs</Link>
          <Link href="/contact" className="block text-gray-800 hover:text-gray-600 mb-2" onClick={handleLinkClick}>Contact us</Link>
